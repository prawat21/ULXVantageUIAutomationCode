...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    ...
    where T : Element
        ...
        public Field GetField(string field, bool waitUntilAvailable = true)
        {
            return _client.GetField(field, waitUntilAvailable);
        }
        ...
        public string GetHeaderContainerValue(string label)
        {
            return _client.GetHeaderContainerValue(label);
        }
        ...
        /// </summary>
        /// /// <param name="control">The lookup field name of the lookup.</param>
        public List<string> GetLookupResults(LookupItem control)
        {
            return _client.GetLookupResults(control);
        }
        ...
        {
            _client.SetValue(control, FormContextType.Entity, useJsScroll);
        }

        /// <summary>
        /// Sets the value of a Lookup without confirmation.
        /// </summary>
        /// <param name="control">The lookup field name, value or index of the lookup.</param>
        public void FillInValue(LookupItem control)
        {
            _client.FillInValue(control, FormContextType.Entity);
        }
        ...
        /// <summary>
        /// Sets the value on the multi picklist type control
        /// </summary>
        /// <param name="option">Object of type MultiValuePicklist containing name of the Field and the values to be set</param>
        public void SetValue(MultiValuePickList pickList)
        {
            _client.SetValue(pickList, FormContextType.Entity);
        }
        ...
        /// </summary>
        /// <param name="control">The activityparty lookup field name, value or index of the lookup.</param>
        public void ClickLookupSearchIcon(LookupItem control)
        {
            _client.ClickLookupSearchIcon(control, FormContextType.Entity);
        }
    }
}
