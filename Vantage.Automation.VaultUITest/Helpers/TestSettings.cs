...
namespace Vantage.Automation.VaultUITest.Helpers
{
    public static class TestSettings
    {
        ...
        private static readonly string RemoteType = ConfigHelper.RemoteBrowserType;
        private static readonly string RemoteHubServerURL = ConfigHelper.RemoteHubServer;
