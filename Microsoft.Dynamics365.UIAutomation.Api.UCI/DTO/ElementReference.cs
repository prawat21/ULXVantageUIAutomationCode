...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    public static class Elements
    {
        public static Dictionary<string, string> Xpath = new Dictionary<string, string>()
        {
            ...
            { "Dialog_ModalHeader" , "//*[@id=\"modalDialogHeader\"]" },
            { "Dialog_ModalOkButton", "//*[@id=\"okButton\"]" },
            ...
            { "Frame_FullPageWebResourceFrame"       , "id(\"FullPageWebResource\")"},
            { "Frame_InlineDialogIFrame"       , "id(\"InlineDialog_Iframe\")"},
            ...
            { "Login_ErrorPage", "//p[contains(text(),'trouble signing you in')]"},
        ...
        public static Dictionary<string, string> ElementId = new Dictionary<string, string>()
        {
            ...
            { "Frame_FullPageWebResourceFrameId"       , "FullPageWebResource"},
            { "Frame_InlineDialogIFrameId"       , "InlineDialog_Iframe"},
    ...
    public static class Reference
    {
        ...
        public static class Dialogs
        {
            ...
            public static string ModalHeader = "Dialog_ModalHeader";
            public static string ModalOkButton = "Dialog_ModalOkButton";
        ...
        public static class Frames
        {
            ...
            public static string InlineDialogIFrame = "Frame_InlineDialogIFrame";
            public static string InlineDialogIFrameId = "Frame_InlineDialogIFrameId";
            public static string FullPageWebResourceFrame = "Frame_FullPageWebResourceFrame";
            public static string FullPageWebResourceFrameId = "Frame_FullPageWebResourceFrameId";
        ...
        public static class Login
        {
            ...
            public static string ErrorPage = "Login_ErrorPage";
