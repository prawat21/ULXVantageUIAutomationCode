...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    public static class AppReference
    {
        ...
        public static class Entity
        {
            ...
            public static string LookupFieldHoverExistingValueButton = "Entity_LookupFieldHoverExistingValueButton";
            ...
            public static string SubGridHeaderTitle = "Entity_SubGridHeaderTitle";
            ...
            public static string EntityBooleanFieldEmptyCheckboxContainer = "Entity_BooleanFieldEmptyCheckboxContainer";
            ...
            public static string EntityPickListSelectValue = "Entity_EntityPickListSelectValue";
            ...
            public static class Header
            {
                ...
                public static string ContainerTextField = "Entity_Header_ContainerField";
            }
        }
        ...
        public static class BusinessProcessFlow
        {
            ...
            public static string FinishButton = "BPF_FinishButton_UCI";
            ...
            public static string HeaderKpiLabel = "BPF_HeaderKpiLabel";
            public static string ActiveStageLabel = "BPF_ActiveStageLabel";
        }
        public static class Dialogs
        {
            ...
            public static string SimpleLookupInput = "Dialog_SimpleLookupInput";
            public static string SimpleLookupListItem = "Dialog_SimpleLookupListItem";
            public static string SimpleLookupAddButton = "Dialog_SimpleLookupAddButton";
            public static string SimpleLookupCancelButton = "Dialog_SimpleLookupCancelButton";
            public static string ConfirmButton = "Dialog_ConfirmButton";
            public static string CancelButton = "Dialog_CancelButton";
            public static string RejectOkButton = "Dialog_RejectOkButton";
            public static string RejectCancelButton = "Dialog_RejectCancelButton";
            public static string RejectReason = "Dialog_RejectReason";
            public static string RejectReasonItem = "Dialog_RejectReasonItem";
            public static string RejectOtherReason = "Dialog_RejectOtherReason";
            public static string ReassignOkButton = "Dialog_ReassignOkButton";
            public static string ReassignCancelButton = "Dialog_ReassignCancelButton";
            public static string ReassignUserOrTeam = "Dialog_ReassignUserOrTeam";
            public static string ReassignReason = "Dialog_ReassignReason";
            public static string ReassignReasonItem = "Dialog_ReassignReasonItem";
            public static string ReportOkButton = "Dialog_ReportOkButton";
            public static string ReportCancelButton = "Dialog_ReportCancelButton";
        ...
        public static class Field
        {
            ...
            public static string ToolTip = "Field_ToolTip";
        }
    ...
    public static class AppElements
    {
        public static Dictionary<string, string> Xpath = new Dictionary<string, string>()
        {
            ...
            { "Entity_LookupFieldHoverExistingValueButton", ".//*[contains(@data-id, '[NAME].fieldControl-LookupResultsDropdown_[NAME]_SelectedRecordList')]//following::button" },
            { "Entity_TextFieldLookupFieldContainer", ".//div[contains(@data-id, '[NAME].fieldControl-Lookup_[NAME]')]" },
            ...
            { "Entity_SubGridHeaderTitle", ".//div[contains(@data-id, 'commandBar')]//preceding-sibling::div"},
            ...
            { "Entity_EditableSubGridList", ".//div[contains(@data-lp-id, \"[NAME]\") and contains(@class, 'editableGrid')]" },
            ...
            { "Entity_BooleanFieldEmptyCheckboxContainer", "//div[contains(@data-id, '[NAME].fieldControl-checkbox-empty-container')]"},
            ...
            { "Entity_OptionSetFieldContainer", ".//div[contains(@data-id,'[NAME].fieldControl-option-set-container')]" },
            ...
            { "Entity_EntityPickListSelectValue", "//label[@title='[NAME]']"},
            ...
            { "Entity_Header_ContainerField", "//div[@role='presentation' and text()='[NAME]']/preceding-sibling::div//*" },
            ...
            { "BPF_HeaderKpiLabel", "//label[contains(@id, 'processHeaderKpiLabel')]" },
            { "BPF_ActiveStageLabel", "//li[contains(@aria-label,'Status: Active')]//label[1]" },
            ...
            { "BPF_FinishButton_UCI"     , "//button[contains(@data-id,'finishButtonContainer')]" },
            ...
            {"Field_ToolTip", ".//span[@role='presentation' and @title]"},
            ...
            { "Dialog_RejectOkButton" , "//*[@id=\"btnOK\"]" },
            { "Dialog_RejectCancelButton" , "//*[@id=\"btnCancel\"]" },
            { "Dialog_RejectReason" , "//*[@id=\"reasonDropDown\"]/span" },
            { "Dialog_RejectReasonItem" , "//li[text()='[NAME]']" },
            { "Dialog_RejectOtherReason" , "//*[@id=\"reasonTextInput\"]" },
            { "Dialog_ReassignOkButton" , "//*[@id=\"ulx_reassign_btnOK\"]" },
            { "Dialog_ReassignCancelButton" , "//*[@id=\"ulx_reassign_btnCancel\"]" },
            { "Dialog_ReassignUserOrTeam" , "//*[@id=\"ulx_textFieldForUserOrTeamInput\"]" },
            { "Dialog_ReassignReason" , "//*[@id=\"ulx_reassign_reasonDropDown\"]/span" },
            { "Dialog_ReassignReasonItem" , "//li[text()='[NAME]']" },
            { "Dialog_SimpleLookupInput" , "//input[contains(@id,'FieldControls.SimpleLookupControl')]" },
            { "Dialog_SimpleLookupListItem" , "//li[contains(@id,'resultsContainer') and contains(@aria-label,'[NAME]')]" },
            { "Dialog_SimpleLookupAddButton" , "//*[@id=\"lookupDialogSaveBtn\"]" },
            { "Dialog_SimpleLookupCancelButton" , "//*[@id=\"lookupDialogCancelBtnFooter\"]" },
            { "Dialog_ReportOkButton" , "//*[@id=\"butBegin\"]" },
            { "Dialog_ReportCancelButton" , "//*[@id=\"cmdDialogCancel\"]" },
