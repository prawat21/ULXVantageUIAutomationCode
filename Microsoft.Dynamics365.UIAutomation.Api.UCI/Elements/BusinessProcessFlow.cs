...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    public class BusinessProcessFlow : Element
    {
        ...
        {
            return _client.BPFGetStatusField();
        }
        ...
        {
            return _client.GetActiveStage().Value;
        }
        ...
        /// <param name="finish">Optional - Clicks the Finish button instead of Next Stage button if true</param>
        public void NextStage(string stageName, Field businessProcessFlowField = null, bool finish = false)
        {
            _client.NextStage(stageName, businessProcessFlowField, finish:finish);
        }
        ...
        {
            _client.ClearValue(control, FormContextType.BusinessProcessFlow);
        }
        ...
        {
            _client.SetValue(control, FormContextType.BusinessProcessFlow, useJsScroll);
        }

        /// <summary>
        /// Sets the value of a DateTimeControl field
        /// </summary>
        /// <param name="field">LookupItem with the schema name of the field to retrieve</param>
