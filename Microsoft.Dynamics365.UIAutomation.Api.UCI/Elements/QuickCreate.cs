...
namespace Microsoft.Dynamics365.UIAutomation.Api.UCI
{
    public class QuickCreate : Element
    {
        ...
        {
            return _client.GetValue(field, isQuickForm: true);
        }
        ...
        {
            return _client.GetValue(option, isQuickForm: true);
        }
        ...
        {
            _client.SetValue(control, FormContextType.QuickCreate, useJsScroll);
        }
